...
#include "RTSDKMovementPostVelocityProcessors.h"
...
URTSDKVelocityCheckProcessor::URTSDKVelocityCheckProcessor()
{
	bRequiresGameThreadExecution = false;
	RTSDK_PROCESSOR_EXEC_ORDER_MOVEMENT_POST_VELOCITY
}

void URTSDKVelocityCheckProcessor::ConfigureQueries()
{
...
void URTSDKVelocityCheckProcessor::Execute(FMassEntityManager& EntityManager, FMassExecutionContext& Context)
{
