...
#include "RTSVisRootInterpolationTranslator.generated.h"

/**
 * 
 */
UCLASS()
class URTSVisRootInterpolationTranslator : public UMassTranslator
{
	GENERATED_BODY()
public:
	//sets some defaults in the class default object
	URTSVisRootInterpolationTranslator();
